              ...
              <form class="theme-form login-form" method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text"><i class="fa-solid fa-envelope"></i></span>
                    <input class="form-control @error('username') is-invalid @enderror" type="username" id="username" placeholder="Email" name="credential" value="{{ old('username') }}">
                    @error('username')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-text"><i class="fa-solid fa-key"></i></span>
