        ...
        <div class="page-main-header">
            <div class="main-header-right row m-0">
                <div class="main-header-left">
                    <div class="logo-wrapper"><a href="dashboard04.html"><img class="img-fluid"
                                src="../assets/images/logo-del-creative.png.png" alt=""></a></div>
        ...
        <div class="page-body-wrapper horizontal-menu">
            ...
            <header class="main-nav">
                <div class="sidebar-user text-center">
                    <a href="profile04.html" class="setting-primary" href="javascript:void(0)"><i
                            data-feather="settings"></i></a><a href="dashboard04.html"><img
                            class="img-90 rounded-circle" src="../assets/images/dashboard/1.png" alt=""
                            href="dashboard04.html"></a>
                    <div class="badge-bottom"><span class="badge badge-primary">New</span></div><a
                        href="dashboard04.html">
                        ...
                        <div id="mainnav">
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="dropdown"><a class="nav-link menu-title link-nav"
                                        href="labcoding04.html"><svg aria-hidden="true" weidth="24" height="24"
                                ...
                                <li class="dropdown"><a class="nav-link menu-title link-nav"
                                        href="forumdiskusi04.html"><i data-feather="list"></i><span>Forum
                                            Diskusi</span></a></li>
                                <li class="dropdown"><a class="nav-link menu-title link-nav"
                    ...
                    <center>
                        <li>
                            <button class="btn btn-outline-success btn-sm" type="button">
                                << </button></a>
                                    <button class="btn btn-outline-success btn-sm" type="button"> 1
                                    </button></a>
                                    <button class="btn btn-outline-success btn-sm" type="button"> 2
                                    </button></a>
                                    <button class="btn btn-outline-success btn-sm" type="button"> 3
                                    </button></a>
                                    <button class="btn btn-outline-success btn-sm" type="button"> 4
                                    </button></a>
                                    <button class="btn btn-outline-success btn-sm" type="button"> 5
                                    </button></a>
                                    <button class="btn btn-outline-success btn-sm" type="button"> >>
                                    </button></a>
                        </li>
